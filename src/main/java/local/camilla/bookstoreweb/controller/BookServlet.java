...
import local.camilla.bookstoreweb.model.dao.BookDAO;
...
public class BookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        private void listBook (HttpServletRequest request, HttpServletResponse response)
             ...
             Logger.getLogger(BookDAO.class.getName()).log(Level.INFO,"Total de requisitos: (0)", listaBook.size());
    ...
    public String getServletInfo() {
        ...
        private void updateBookAction (HttpServletRequest request, HttpServletResponse response)
            ...
            bookAtualizado.setTitulo(request.getParameter(request.getParameter("formTitulo")));
